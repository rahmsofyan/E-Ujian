...
<div id="page-wrapper">
  <div class="row">
    <div class="col-lg-12">
      ...
      <hr class="col-md-12">
      <a href="{{ route('AgendaByPIC') }}" class="btn btn-danger">Kembali</a>
      <a href="{{route('AgendaByPIC.add')}}" class="btn btn-primary">Tambah Berita Acara</a>
    </div>
  </div>
      ...
      <table class="table table-bordered table-striped" id="tableabsen" style="width:100%">
        ...
        @foreach($a as $key => $absenKuliah)
          <tr>
            ...
            <td> <a href="{{ route('AgendaByPIC.edit', $absenKuliah->id) }}" class="btn btn-warning">Edit</a> </td>
          </tr>
        @endforeach
        </tbody>
      </table>
