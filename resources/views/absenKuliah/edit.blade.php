...
<div id="page-wrapper">
  ...
  <div class="panel panel-default"> 
    ...
    <div class="panel-body border border-primary">
     <form class="form-horizontal" action="{{ route('absenKuliah.update', $a->id) }}" method="POST">
      @csrf
       ...
       <div class="form-group">
          ...
          <div class="col-sm-10">
            ...
            <input type="number" name="pertemuanKe" class="form-control" id="pertemuanKe" value="{{ $a->pertemuanKe }}">
          </div>
       </div>
